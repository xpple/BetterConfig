...
/// @param <P> the chat component type: [net.minecraft.network.chat.Component] on Fabric
///           and [net.kyori.adventure.text.Component] on Paper
public interface ModConfig<P> {
    ...
    /// Get all registered command aliases for this mod.
    /// @return the set of registered command aliases.
    ...
    /// Reset all the [Config#temporary()] configs.
    ...
    /// Reload this configuration. Every config field that is not marked as [Config#temporary()]
